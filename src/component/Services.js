            ...
            <div className="row justify-content-md-center">
              ...
              >
                <div className="service_content_box relative-position">
                  ...
                  <div className="service_text_box saas2-headline pera-content">
                    <h3>Decentralized</h3>
                    <p>
                      There are no managers or admins at the top, the creators
                      are participants like everyone else.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="service_content_box relative-position">
                  ...
                  <div className="service_text_box saas2-headline pera-content">
                    <h3>Immutable Conditions</h3>
                    <p>
                      Blockchain secures the COINSBOLT algorithm, so nobody, not
                      even the creators can interfere with your transactions.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="service_content_box relative-position">
                  ...
                  <div className="service_text_box saas2-headline pera-content">
                    ...
                    <p>
                      All transactions within members are done from one personal
                      wallet to another. There are no accounts to withdraw from
                      and COINSBOLT does not store your funds.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="service_content_box relative-position">
                  ...
                  <div className="service_text_box saas2-headline pera-content">
                    ...
                    <p>
                      ...
                      you do everything from animating interactions.
                    </p>
                  </div>
                </div>
              </div>

      ...
      <section id="s2-pricing" className="s2-pricing_section">
        <div className="container">
          <div className="saas_two_section_title saas2-headline text-center">
            <span className="title_tag">Pricing</span>
            <h2 style={{ color: "#fff" }}> Our best pricing offer!</h2>
          </div>
          <div className="s2-pricing_content">
            <div className="row justify-content-md-center">
              <div
                className="col-lg-3 col-md-6 wow fadeFromLeft"
                data-wow-delay="0ms"
              ...
              >
                <div className="s2-pricing_item">
                  ...
                  <div className="s2-pricing_list ul-li-block">
                    <ul>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked float-left text-center" />
                        YOU SUPOSE TO REFFER 2 DIRECT
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked  float-left text-center" />
                        YOU EARN 10$ EACH =20$
                      ...
                      <li>
                        <div className="s2-pricing_list_icon s2-checked  float-left text-center" />
                        YOU CAN JOIN WITH $10
                      </li>
                    </ul>
                  </div>
                  <div className="s2-pricing_btn">
                    <a href="#">
                      <i className="fas fa-cloud-download-alt" /> Join Now
                    </a>
                  </div>
                </div>
              </div>
                  ...
                  <div className="s2-pricing_list ul-li-block">
                    <ul>
                      <li>
                        ...
                        HELP YOUR TEAM FOR 2ND LEVEL
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked  float-left text-center" />
                        YOU NEED UPGRADE OF $20
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked  float-left text-center" />
                        YOU EARN 20$ EACH = 80$
                ...
                <div className="s2-pricing_item">
                  ...
                  <div className="s2-pricing_list ul-li-block">
                    <ul>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked float-left text-center" />
                        HELP YOUR TEAM FOR 3RD LEVEL
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked  float-left text-center" />
                        YOU NEED UPGRADE OF $40
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked float-left text-center" />
                        YOU EARN 40$ EACH = 320$
                      </li>
                    </ul>
                  </div>
                  <div className="s2-pricing_btn">
                ...
                <div className="s2-pricing_item">
                  ...
                  <div className="s2-pricing_list ul-li-block">
                    <ul>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked float-left text-center" />
                        HELP YOUR TEAM FOR 4TH LEVEL
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked  float-left text-center" />
                        YOU NEED UPGRADE OF $80
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked float-left text-center" />
                        YOU EARN 80$ EACH = 1280$
                      </li>
                    </ul>
                  </div>
                  <div className="s2-pricing_btn">
                ...
                <div className="s2-pricing_item">
                  ...
                  <div className="s2-pricing_list ul-li-block">
                    <ul>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked float-left text-center" />
                        HELP YOUR TEAM FOR 5TH LEVEL
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked  float-left text-center" />
                        YOU NEED UPGRADE OF $160
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked  float-left text-center" />
                        YOU EARN 160$ EACH = 5120$
                      </li>
                    </ul>
                  </div>
                  <div className="s2-pricing_btn">
                  ...
                  <div className="s2-pricing_list ul-li-block">
                    <ul>
                      <li>
                        ...
                        HELP YOUR TEAM FOR 6TH LEVEL
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked  float-left text-center" />
                        YOU NEED UPGRADE OF $320
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked  float-left text-center" />
                        YOU EARN 320$ EACH = 20480$
                      </li>
                    </ul>
                  </div>
                  <div className="s2-pricing_btn">
                ...
                <div className="s2-pricing_item">
                  ...
                  <div className="s2-pricing_list ul-li-block">
                    <ul>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked float-left text-center" />
                        HELP YOUR TEAM FOR 7TH LEVEL
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked  float-left text-center" />
                        YOU NEED UPGRADE OF $640
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked float-left text-center" />
                        YOU EARN 640$ EACH = 81920$
                      </li>
                    </ul>
                  </div>
                  <div className="s2-pricing_btn">
                ...
                <div className="s2-pricing_item">
                  ...
                  <div className="s2-pricing_list ul-li-block">
                    <ul>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked float-left text-center" />
                        HELP YOUR TEAM FOR 8TH LEVEL
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked  float-left text-center" />
                        YOU NEED UPGRADE OF $1280
                      </li>
                      <li>
                        <div className="s2-pricing_list_icon s2-checked float-left text-center" />
                        YOU EARN 1280$ EACH = 327680$
                      </li>
                    </ul>
                  </div>
                  <div className="s2-pricing_btn">
